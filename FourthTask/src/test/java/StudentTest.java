...
public class StudentTest {
    ...
    public static void createNewStudent() {
        ...
        st1 = new Student("Petrenko", "Anatoliy", "Ignatovych", 18, "K-215m", m1);
        st2 = new Student("Kronenberg", "Lubomir", "Viktorovich", 20, "G-311a", m2);
        st3 = new Student("Kryvolapenko", "Vasyl", "Igorovych", 19, "M-456v", m3);
    }
